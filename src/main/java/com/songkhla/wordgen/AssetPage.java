...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
           if(jTableAsset.getSelectedRow()>=0){
            try{
                String crimecaseno = jTableAsset.getModel().getValueAt(jTableAsset.getSelectedRow(), 0)+"";
                ...
                String sql = "Delete from Asset WHERE EvidenceRecordNumber='"+EvidenceRecordNumber+ "'and  crimecaseno='"+crimecaseno+"' and name='"+name+"'";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(jTableAsset.getSelectedRow()>=0){
            try{
                ...
                String EvidenceRecordNumber = jTableAsset.getModel().getValueAt(jTableAsset.getSelectedRow(), 1)+"";
                String Name = jTableAsset.getModel().getValueAt(jTableAsset.getSelectedRow(), 2)+"";
                String sql = "select * from Asset where EvidenceRecordNumber='"+EvidenceRecordNumber+ "' and  crimecaseno='"+crimecaseno+" 'and Name='"+Name+"'";
                Connection con = ConnectDatabase.connect();
                Statement stmt = con.createStatement();
