...
//               
                  ...
                  while (rs1.next()) {                    
                   ...
                   String sql="select crimecase.*,Charge.*,ActionsCase.*,Asset.*,P1.*,P2.*\n" +
...
//              
		...
		bookmarkvalue.put("C2",cs);
                bookmarkvalue.put("C3", ccYear);
                 ...
                 bookmarkvalue.put("S22",LocationOfDrug);
                  ...
                  bookmarkvalue.put("PS15",  s.getString("suspectNati"));
                      ...
                      bookmarkvalue.put("AS64", s.getString("PlaceFoundExhibit"));
                        ...
                        bookmarkvalue.put("P05", Position);
                            ...
                            bookmarkvalue.put("C16", s.getString("DocOrder"));
                            bookmarkvalue.put("C17", s.getString("DocSlash"));
                            
                            
                            bookmarkvalue.put("AS87", s.getString("SerialNO"));
                            bookmarkvalue.put("AS88", s.getString("Brand"));
                            bookmarkvalue.put("AS90", s.getString("Color"));
...
//			table1.add(repl2);
		...
		try {
			...
			wordMLPackage.save(new java.io.File("D:/สำนวนอิเล็กทรอนิกส์"+"/"+PoliceStationName+"/คดีอาญา"+cs+"-"+ccYear+"/บันทึกการตรวจสภาพรถ.doc"));
		}catch( Exception ex) {
			ex.printStackTrace();
		}
            }
