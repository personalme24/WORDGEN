                  ...
                  bookmarkvalue.put("PS15", Checknull(s.getString("suspectNati")));
                      ...
                      bookmarkvalue.put("AS64", Checknull(s.getString("PlaceFoundExhibit")));
                        ...
                        bookmarkvalue.put("P05", Checknull(Position));
                            ...
                            bookmarkvalue.put("C411", Checknull(s.getString("OccuredTime")));
                            bookmarkvalue.put("C5", Checknull(ToDate(s.getString("CaseAcceptDate"))));
                            bookmarkvalue.put("C511", Checknull(s.getString("CaseAccepTime")));
...
//			table1.add(repl2);
		...
		try {
			...
			wordMLPackage.save(new java.io.File("D:/สำนวนอิเล็กทรอนิกส์"+"/"+PoliceStationName+"/ปี"+ccYear+"/"+casetype+"/"+casetype+cs+"-"+ccYear+"/ส่งของกลางตรวจพิสูจน์ฯ"+cs+"-"+ccYear+".doc"));
		}catch( Exception ex) {
			ex.printStackTrace();
		}
            }
