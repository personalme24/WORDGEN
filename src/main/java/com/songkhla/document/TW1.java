...
public class TW1 {
    public static void tw1(String cc) {
...
//			table1.add(repl2);
		...
		try {
			...
			wordMLPackage.save(new java.io.File("D:/สำนวนอิเล็กทรอนิกส์"+"/"+PoliceStationName+"/แบบฟอร์มสำนวน"+"/บันทึกการตรวจสำนวนการสอบสวน.doc"));
		}catch( Exception ex) {
			ex.printStackTrace();
		}
            }
	...
	private static void replaceTable(JSONArray placeholders, JSONArray data,
     ...
     private static String ToDate(String strDate){
         ...
         try {
             ...
             Logger.getLogger(TW1.class.getName()).log(Level.SEVERE, null, ex);
         }
               return ResultDate;
     }
